...
import com.chocobo.esm.validator.GiftCertificateValidator;
import com.chocobo.esm.validator.SortStringValidator;
...
public class GiftCertificateServiceTest {
    ...
    @Mock
    private SortStringValidator sortStringValidator;
    ...
    void testFilter() {
        ...
        List<GiftCertificateDto> actualDtoList = certificateService.filter(tagName, name, description, sort);
    ...
    void testUpdateInvalidTagEntity() {
        ...
        GiftCertificate certificate = provideCertificate();
        GiftCertificateDto updatedCertificateDto = provideCertificateDto();
        updatedCertificateDto.setTags(new HashSet<>() {{ add(provideTagDto()); }});
